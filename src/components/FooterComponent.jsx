        ...
        <Row className="d-flex justify-content-between">
          <Col lg="5">
            ...
            <p className="desc">
              ...
              atque quibusdam adipisci quaerat cumque, facere et tenetur non
              distinctio corrupti?
            </p>
          ...
          <Col lg="4" className="mt-lg-0 mt-5">
            <h5 className="fw-bold mb-3">
              Subscribe Untuk Info Menarik Lainnya.
            </h5>
        ...
        <Row>
          <Col>
            <p className="text-center px-md-0 px-3">
              ...
              <span className="fw-bold">Ngoding.</span> All Right Reserved.
            </p>
          </Col>
        </Row>
      </Container>
